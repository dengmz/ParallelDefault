#
#Standard Julia performance estimation by @time
#@benchmark method included in another file

#=
Variables to modify:
Ny: number of endowment points
Nb: number of debt points
maxIter: maximum iterations for value iteration procedure
in_iter: in each iteration, times of repeating each component consecutively to reduce measurement error through @time
=#
Ny = 7 #grid number of endowment
Nb = 10000 #grid number of bond
maxIter = 7#Maximum interation
in_iter = 7#repetition in each iteration
