...
#Based on Paper Part4, Sovereign meets C++
    ...
    println("Time VD=", time_vd/iter)
    println("Time VR=", time_vr/iter)
    println("Time Decide=", time_decide/iter)
    println("Time Update=", time_update/iter)
